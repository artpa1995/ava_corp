        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th>Account Status for this Tax Year</th>
            ...
            <tbody>
                @foreach($tax_returns as $tax_return)
                    <tr>
                        <td>
                            @if($tax_return->account)
                                {{-- <a href="/account/{{$tax_return->account->id}}">{{$tax_return->account->name??""}}</a> --}}
                            @endif
                        </td>
                        ...
                        <td>{{$tax_return->account_status ? $tax_account_status[$tax_return->account_status] : ""}}</td>
                        <td>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                ...
                                <a class="data_delete_href_from cursor-pointer" data-toggle="modal" data-target="#exampleModal" data-href="{{ route('delete_tax_returns_account', [$tax_return->id]) }}">
